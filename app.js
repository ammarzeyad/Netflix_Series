...
if (Favorit_Series == "The Queen's Gambit") {
    document.write(
      "<div>" + "<h3>" + Favorit_Series + "</h3>"
...
if (Favorit_Movies == "The Social Network’ ") {
      document.write(
        "<div>" + "<h3>" + Favorit_Movies + "</h3>"
...
=======
var Favorit_Series = prompt("What is you FavoritSeries ?")

if(Favori_tSeries == "Peaky Blinders"){
document.write(
  "<div>" + "<h3>" + Favorit_Series+"</h3>"
  +
...
document.write(
  "<div>" + "<h3>" + Favorit_Series+"</h3>"
  +
  "https://comicyears.com/wp-content/uploads/2020/10/The-Queens-Gambit-Review-Netflix-tv-series.jpg"
}

else if(Favorit_Movies =="God Father"){
document.write(
  "<div>" + "<h3>" + Favorit_Movies+"</h3>"
+ "<img  src='https://wallpaperaccess.com/full/1107715.jpg" + "</div>")
}
...
>>>>>>> bb9744d9146877930d80120832e772a4803a1059
